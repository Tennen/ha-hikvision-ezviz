...
from ..sdk.client import HcNetSdkClient, SdkCallError
from ..sdk.ctypes_defs import PLAY_DATA_CALLBACK
...
class PlaybackSession:
    ...
    def __init__(
        ...
        self.base_dir = Path("/tmp/ezviz_hcnet") / self.session_id
            ...
            try:
                while True:
                    ...
                    try:
                        ...
                        break
            except Exception as err:  # pragma: no cover - background thread safety
    ...
    def _attach_callback(self) -> None:
        ...
        def _on_data(
            ...
            try:
                ...
                # Drop when ffmpeg is slower than playback callback.
                pass
            except Exception:
    ...
    def info(self, hls_url: str) -> PlaybackInfo:
        return PlaybackInfo(
...
class PlaybackSessionManager:
    """Async manager enforcing one session per config entry."""

    def __init__(self, hass: HomeAssistant, client: HcNetSdkClient, entry_id: str) -> None:
        self.hass = hass
        self.client = client
        self.entry_id = entry_id
